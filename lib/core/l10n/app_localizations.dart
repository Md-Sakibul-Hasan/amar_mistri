...
class AppLocalizations {
  ...
  String get selectLanguage =>
      _t('Select Language', 'ভাষা নির্বাচন করুন');
  ...
  String get logoutConfirmBody =>
      _t('Are you sure you want to logout?', 'আপনি কি সত্যিই লগআউট করতে চান?');
  String get noBookingsYet =>
      _t('No bookings yet', 'এখনো কোনো বুকিং নেই');
  String get noBookingsYetDot =>
      _t('No bookings yet.', 'এখনো কোনো বুকিং নেই।');
  String get phoneNumberCopied =>
      _t('Phone number copied', 'ফোন নম্বর কপি হয়েছে');
  ...
  String get splashTagline =>
      _t('Find trusted local services near you', 'বিশ্বস্ত স্থানীয় সেবা খুঁজুন');

  // ── Role selection ─────────────────────────────────────────────────────────
  String get roleSelectionSubtitle =>
      _t('How would you like to continue?', 'আপনি কীভাবে এগিয়ে যেতে চান?');
  String get roleCustomerTitle => _t('I need a service', 'আমার সেবা দরকার');
  String get roleCustomerSubtitle =>
      _t('Find and hire skilled professionals', 'দক্ষ পেশাদার খুঁজুন ও নিয়োগ করুন');
  String get roleProviderTitle =>
      _t('I provide services', 'আমি সেবা প্রদান করি');
  String get roleProviderSubtitle =>
      _t('Offer your skills and grow your business',
          'আপনার দক্ষতা অফার করুন এবং ব্যবসা বাড়ান');

  // ── Auth header ────────────────────────────────────────────────────────────
  String get providerPortal => _t('Provider Portal', 'প্রদানকারী পোর্টাল');
  String get localServicePartner =>
      _t('Your local service partner', 'আপনার স্থানীয় সেবার সঙ্গী');

  // ── Login ──────────────────────────────────────────────────────────────────
  String get welcomeBack => _t('Welcome Back!', 'স্বাগতম!');
  String get loginToContinue =>
      _t('Login to continue', 'চালিয়ে যেতে লগইন করুন');
  ...
  String get orContinueWith =>
      _t('or continue with', 'বা এর সাথে চালিয়ে যান');
  ...
  String get signUpToGetStarted =>
      _t('Sign up to get started', 'শুরু করতে নিবন্ধন করুন');
  ...
  String get servicesOffered =>
      _t('Services Offered', 'প্রদানকৃত সেবাসমূহ');
  ...
  String get serviceAreaHint =>
      _t('Enter your service area', 'আপনার সেবা এলাকা লিখুন');
  ...
  String get profilePhotoUpdated =>
      _t('Profile photo updated', 'প্রোফাইল ছবি আপডেট হয়েছে');
  String get profileUpdatedSuccessfully =>
      _t('Profile updated successfully', 'প্রোফাইল সফলভাবে আপডেট হয়েছে');

  // ── Home header ────────────────────────────────────────────────────────────
  String get locationText =>
      _t('Rajshahi, Bangladesh', 'রাজশাহী, বাংলাদেশ');
  String get searchHint =>
      _t('Search for a service...', 'একটি সেবা খুঁজুন...');
  String get setServiceArea =>
      _t('Set service area', 'সেবা এলাকা সেট করুন');
  String get onlineAcceptingBookings =>
      _t('You are currently online and accepting bookings',
          'আপনি এখন অনলাইন এবং বুকিং গ্রহণ করছেন');

  // ── Customer home ──────────────────────────────────────────────────────────
  String get myBookings => _t('My Bookings', 'আমার বুকিং');
  String get myBookingsSubtitle =>
      _t('View all your booking requests and details',
          'আপনার সকল বুকিং অনুরোধ ও বিবরণ দেখুন');
  ...
  String get howItWorks =>
      _t('How Amar Mistri Works', 'আমার মিস্ত্রি যেভাবে কাজ করে');
  ...
  String get bookingJobDetailsHint =>
      _t('Provide job details so the provider can prepare properly.',
          'কাজের বিবরণ দিন যাতে সেবাদাতা ঠিকমতো প্রস্তুতি নিতে পারেন।');
  ...
  String get describeTheProblem =>
      _t('Describe the problem clearly', 'সমস্যাটি স্পষ্টভাবে বর্ণনা করুন');
  String get descriptionRequired =>
      _t('Description is required', 'বিবরণ প্রয়োজন');
  ...
  String get whatHappensNext =>
      _t('What happens next?', 'পরবর্তীতে কি হবে?');
  String get whatHappensNextBody =>
      _t('The provider will confirm your request and contact you to schedule a visit.',
  ...
  String get stayNotifiedBody =>
      _t('You will receive a notification once the provider accepts your booking.',
          'সেবাদাতা আপনার বুকিং গ্রহণ করলে আপনি একটি বিজ্ঞপ্তি পাবেন।');
  String get viewMyBookings =>
      _t('View My Bookings', 'আমার বুকিং দেখুন');
  String get backToHome => _t('Back to Home', 'হোমে ফিরে যান');

  // ── Booking list ───────────────────────────────────────────────────────────
  String get bookingsYetBody =>
      _t('Your bookings will appear here after you place one.',
          'বুকিং করলে এখানে দেখাবে।');
  String get couldNotLoadBookings =>
      _t('Could not load bookings', 'বুকিং লোড করা যায়নি');
  ...
  String get recentBookings =>
      _t('Recent Bookings', 'সাম্প্রতিক বুকিং');
  ...
  String get bookingSummary =>
      _t('Booking Summary', 'বুকিং সারসংক্ষেপ');
  ...
  String noProvidersFound(String service) =>
      _bn ? 'কোনো $service প্রদানকারী পাওয়া যায়নি' : 'No $service providers found';
  String get checkBackSoon =>
      _t('Check back soon — more are joining!', 'শীঘ্রই আবার দেখুন — আরও যোগ দিচ্ছেন!');
